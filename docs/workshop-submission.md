...
- The email subject line must contain:
  ...
  - :::info NOTE
    The **member Identifier** is only required for the **video presentation** submission.
    :::
...
- The file you submit must be a **UTF-8 TEXT file** that can be opened on any operating system using a **basic text editor**
...
- **Paste** the shared **link** into your **email message body**
- Send!
